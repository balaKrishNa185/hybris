...
public class DefaultWebservicesService implements WebservicesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultWebservicesService.class);
	...
	{
		return DefaultWebservicesService.class.getResourceAsStream("/Webservices/sap-hybris-platform.png");
	}
