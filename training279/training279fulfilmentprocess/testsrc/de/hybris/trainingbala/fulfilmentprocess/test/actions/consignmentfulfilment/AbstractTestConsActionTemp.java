 ...
 */
package de.hybris.trainingbala.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, Training279FulfilmentProcessConstants.PARENT_PROCESS);
