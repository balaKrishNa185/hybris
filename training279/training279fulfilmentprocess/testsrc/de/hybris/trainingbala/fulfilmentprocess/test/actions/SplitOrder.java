 ...
 */
package de.hybris.trainingbala.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(Training279FulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(Training279FulfilmentProcessConstants.PARENT_PROCESS);
