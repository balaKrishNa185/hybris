 ...
 */
package de.hybris.trainingbala.fulfilmentprocess.test.jobs;
...
import de.hybris.trainingbala.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = Training279FulfilmentProcessConstants.ORDER_PROCESS_NAME;
