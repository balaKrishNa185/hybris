...
public class IsNewPopulator extends CustomerPopulator implements Populator<CustomerModel, CustomerData> {
    ...
    public void populate(CustomerModel customerModel, CustomerData customerData) throws ConversionException {
        ...
        if (customerModel.getIsNew() != null) {
            customerData.setIsNew(customerModel.getIsNew());
            LOG.info("IsNewCustomerPopulator class is called" +customerData.getIsNew());
        }
    }
}
