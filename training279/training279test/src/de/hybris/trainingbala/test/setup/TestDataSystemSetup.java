 ...
 */
package de.hybris.trainingbala.test.setup;
...
import de.hybris.trainingbala.test.constants.Training279TestConstants;
import de.hybris.trainingbala.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = Training279TestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/training279test/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/training279test/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/training279test/import/cstickets.impex");
			...
			importImpexFile(context, "/training279test/import/csquotes.impex");
		}
	}
}
