 ...
 */
package de.hybris.trainingbala.storefront.controllers;
...
public interface ControllerConstants
{
	...
	interface Actions
	{
		interface Cms // NOSONAR
		{
			...
			String _Suffix = "Controller"; // NOSONAR//ControllerConstants.Views.Pages.Product.OrderForm;
			...
			String LatestComponent=_Prefix + LatestProductComponentModel._TYPECODE + _Suffix;
		}
	}
	...
	interface Views
	{
		...
		interface Pages
		{
			...
			interface custom
			{
				String  ManufacturerDetails="pages/custom/manufacturerDetailsPage";
				String ProductDetails="pages/custom/LatestProduct";
				String ProductionDetails="pages/custom/onePc";
				String ALLProductionDetails="pages/custom/allPc";
				String ALLProductionDetailsbyPagination="pages/custom/allbypage";
			}
			interface ManufacturerDetails
			{
				String ALLManufacturerDetails="pages/custom/allManufacturerDetailsPage";
				String ALLManufacturerDetailsByPagination="pages/custom/allManufacturerDetailsPageByPagination";
				String AddManufacturerDetails="pages/custom/addManufacturerDetails";
				String saveManufacturerDetails="pages/custom/savedMessage";
			}

			interface Customers
			{
				String AllCustomers="pages/custom/allCustomers";
				String Customers="pages/custom/customers";
				String Cus="pages/custom/customer";
			}
		}
		...
		interface Fragments
		{
			...
			interface Checkout // NOSONAR
			{
				...
				String ISNEWBUSINESSUSER ="fragments/checkout/isNewBusinessUserPopup";
			}
