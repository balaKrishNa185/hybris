 ...
 */
package de.hybris.trainingbala.storefront.controllers.pages.checkout.steps;
...
import de.hybris.trainingbala.storefront.controllers.command.CustomAddressDataUtil;
import de.hybris.trainingbala.storefront.controllers.command.CustomAddressForm;
import de.hybris.trainingbala.storefront.controllers.command.validation.CustomAddressValidator;
...
public class DeliveryAddressCheckoutStepController extends AbstractCheckoutStepController
{
			...
			final RedirectAttributes redirectAttributes) throws CMSItemNotFoundException
	{
		...
		{
			//customize
			customAddressDataUtil.convert(addressData, addressForm);
		}
	...
	@RequireHardLogIn
	public String edit(final AddressForm addressForm1, final BindingResult bindingResult, final Model model,
			final RedirectAttributes redirectModel) throws CMSItemNotFoundException
	{
		CustomAddressForm addressForm= (CustomAddressForm) addressForm1;
		customAddressValidator.validate(addressForm, bindingResult);
