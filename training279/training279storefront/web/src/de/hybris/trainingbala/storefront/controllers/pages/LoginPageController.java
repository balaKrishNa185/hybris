 ...
 */
package de.hybris.trainingbala.storefront.controllers.pages;
...
import de.hybris.trainingbala.storefront.controllers.command.validation.CustomRegistrationValidator;
...
public class LoginPageController extends AbstractLoginPageController {
	...
	public String doRegister(@RequestHeader(value = "referer", required = false) final String referer, final RegisterForm form
			, final CustomRegisterForm cForm, final BindingResult bindingResult, final Model model, final HttpServletRequest request,
							 final HttpServletResponse response, final RedirectAttributes redirectModel) throws CMSItemNotFoundException {

		customRegistrationValidator.validate(cForm, bindingResult);
		return processRegisterUserRequest(referer, cForm, bindingResult, model, request, response, redirectModel);
	}
	...
	@Override
	protected String processRegisterUserRequest(final String referer, final RegisterForm form1, final BindingResult bindingResult,
												final Model model, final HttpServletRequest request, final HttpServletResponse response,
												final RedirectAttributes redirectModel) throws CMSItemNotFoundException // NOSONAR
	{
		CustomRegisterForm form= (CustomRegisterForm) form1;

		if (bindingResult.hasErrors()) {
			form.setTermsCheck(false);
			form.setNewBusinessUser(false);
		...
		data.setIsNewBusinessUser(form.isNewBusinessUser());
		try {
