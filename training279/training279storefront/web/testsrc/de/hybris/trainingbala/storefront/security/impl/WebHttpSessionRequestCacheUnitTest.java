...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/training279storefront/electronics/en",
						"https://electronics.local:9002/training279storefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/training279storefront/electronics/en",
						"https://electronics.local:9002/training279storefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/training279storefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/training279storefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/training279storefront/electronics/en",
						"https://electronics.local:9002/training279storefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/training279storefront",
						"https://electronics.local:9002/training279storefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/training279storefront",
						"https://electronics.local:9002/training279storefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/training279storefront/electronics/en",
						"https://electronics.local:9002/training279storefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
