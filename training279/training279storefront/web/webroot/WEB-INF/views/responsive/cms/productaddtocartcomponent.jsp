...
<div class="addtocart-component">
		...
		<div class="qty-selector input-group js-qty-selector">
			...
			<font color="#580229" size="2px" bold="strong">IsNewProduct ::</font> <font color="#4C33FF">${product.isNewProduct} </font>
			<font color="#580229" size="2px" bold="strong">IsNewProduct ::</font> <font color="#4C33FF">${product.isTest} </font>
			<font color="#580229" size="2px" bold="strong">IsNewProduct ::</font> <font color="#4C33FF">${product.isCount} </font>

			<table width="20" cellpadding="2" cellspacing="2">
				<tr>
				<th>id</th>
				<th>name</th>
				<th>country</th>
