 ...
 */
package de.hybris.trainingbala.core.suggestion;
...
import de.hybris.trainingbala.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/training279core/test/testSimpleSuggestionService.csv", "utf-8");
	}
